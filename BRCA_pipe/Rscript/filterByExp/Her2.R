...
dir.create("intermediate/Her2/filterByExp")
dir.create("RData/Her2/filterByExp")
...
string_edge_data <- read.table("intermediate/Her2/filterByExp/STRING network (physical) default edge.csv", header = T, sep = ",", stringsAsFactors = F)
...
string_node_data <- read.table("intermediate/Her2/filterByExp/STRING network (physical) default node.csv", header = T, sep = ",", stringsAsFactors = F)
...
save(final_df, gene_data, file = "RData/Her2/filterByExp/PCSF_input.RData")


# compare STRING outputs
custom_filt_string_node <- read.csv("intermediate/Her2/STRING network (physical) default node.csv")
...
venn.diagram(
  ...
  cex = 1.5,  # increase the size of the circles
  margin = 0.1,  # set the margin size (proportion of the plot)
  filename = "intermediate/Her2/filterByExp/string_node_compare.png",
  disable.logging = TRUE
)

load("RData/Her2/PCSF_input.RData")
...
venn.diagram(
  ...
  cex = 1.5,  # increase the size of the circles
  margin = 0.1,  # set the margin size (proportion of the plot)
  filename = "intermediate/Her2/filterByExp/string_edge_compare.png",
  disable.logging = TRUE
)
...
save(subnet, file = "RData/Her2/filterByExp/PCSF_subnet.RData")
...
write.csv(df, "intermediate/Her2/filterByExp/PCSF_output.csv", row.names = F)
...
write.csv(PCSF_results, "intermediate/Her2/filterByExp/PCSF_druggability.csv")
...
write.csv(filtered_results, "intermediate/Her2/filterByExp/PCSF_master_unique.csv")
...
write.csv(final_gene_counts, "intermediate/Her2/filterByExp/final_gene_counts.csv", row.names = F)


custom_filt_final_counts <- read.csv("intermediate/Her2/final_gene_counts.csv")
venn.diagram(
  ...
  cex = 1.5,  # increase the size of the circles
  margin = 0.1,  # set the margin size (proportion of the plot)
  filename = "intermediate/Her2/filterByExp/final_gene_counts_compare.png",
  disable.logging = TRUE
)
