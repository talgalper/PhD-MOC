...
dif_exp <- DE_results$GTEx_lumB$dif_exp
...
write.table(gene_data$external_gene_name, "intermediate/lumB/filterByExp/GTEx/gene_list.txt", quote = F, row.names = F, col.names = F)
...
string_edge_data <- read.table("intermediate/lumB/filterByExp/GTEx/STRING network (physical) default edge.csv", header = T, sep = ",", stringsAsFactors = F)
...
string_node_data <- read.table("intermediate/lumB/filterByExp/GTEx/STRING network (physical) default node.csv", header = T, sep = ",", stringsAsFactors = F)
...
save(final_df, gene_data, file = "RData/lumB/filterByExp/GTEx/PCSF_input.RData")
...
save(subnet, file = "RData/lumB/filterByExp/GTEx/PCSF_subnet.RData")
...
write.csv(df, "intermediate/lumB/filterByExp/GTEx/PCSF_output.csv", row.names = F)
...
write.csv(PCSF_results, "intermediate/lumB/filterByExp/GTEx/PCSF_druggability.csv")
...
write.csv(filtered_results, "intermediate/lumB/filterByExp/GTEx/PCSF_master_unique.csv")
...
write.csv(final_gene_counts, "intermediate/lumB/filterByExp/GTEx/final_gene_counts.csv", row.names = F)
