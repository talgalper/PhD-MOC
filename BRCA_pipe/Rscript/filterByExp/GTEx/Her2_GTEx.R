...
dif_exp <- DE_results$GTEx_Her2$dif_exp
...
write.table(gene_data$external_gene_name, "intermediate/Her2/filterByExp/GTEx/gene_list.txt", quote = F, row.names = F, col.names = F)
...
string_edge_data <- read.table("intermediate/Her2/filterByExp/GTEx/STRING network (physical) default edge.csv", header = T, sep = ",", stringsAsFactors = F)
...
string_node_data <- read.table("intermediate/Her2/filterByExp/GTEx/STRING network (physical) default node.csv", header = T, sep = ",", stringsAsFactors = F)
...
save(final_df, gene_data, file = "RData/Her2/filterByExp/GTEx/PCSF_input.RData")
...
save(subnet, file = "RData/Her2/filterByExp/GTEx/PCSF_subnet.RData")
...
write.csv(df, "intermediate/Her2/filterByExp/GTEx/PCSF_output.csv", row.names = F)
...
write.csv(PCSF_results, "intermediate/Her2/filterByExp/GTEx/PCSF_druggability.csv")
...
write.csv(filtered_results, "intermediate/Her2/filterByExp/GTEx/PCSF_master_unique.csv")
...
write.csv(final_gene_counts, "intermediate/Her2/filterByExp/GTEx/final_gene_counts.csv", row.names = F)
