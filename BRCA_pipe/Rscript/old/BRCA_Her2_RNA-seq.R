...
string_edge_data <- read.table("intermediate/Her2/STRING network (physical) default edge.csv", header = T, sep = ",", stringsAsFactors = F)
...
string_node_data <- read.table("intermediate/Her2/STRING network (physical) default node.csv", header = T, sep = ",", stringsAsFactors = F)
...
save(final_df, gene_data, file = "RData/Her2/PCSF_input.RData")
...
save(subnet, file = "RData/Her2/PCSF_subnet.RData")
