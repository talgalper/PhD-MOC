...
selected_barcodes <- selected_barcodes[selected_barcodes$Subtype_Selected == "BRCA.LumA", ]
...
save(LumA_unstranded, GTEx_data, file = "RData/BRCA_lumA_DE_data.RData")
...
merged_df <- merge(LumA_unstranded, GTEx_data, by = "row.names")
...
save(dif_exp, hits, file = "RData/lumA/DE_results.RData")
