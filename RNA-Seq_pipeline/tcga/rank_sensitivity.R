...
#write.csv(tcga_gene_counts, "no_gepia/tcga_sensitivity_rank.csv")


# compare with kylie sensitivity
tcga_gene_counts <- read.csv("tcga_sensitivity_rank.csv", row.names = 1)
kylie_gene_counts <- read.csv("../pcsf_kylie/string_run/kylie_sensitivity_rank.csv", row.names = 1)
tcga_vs_gtex_gene_counts <- read.csv("no_gepia/tcga_sensitivity_rank.csv", row.names = 1)

common_gepia_vs_edgeR_pipe <- tcga_vs_gtex_gene_counts[tcga_vs_gtex_gene_counts$gene %in% tcga_gene_counts$gene, ]
common_edgeR_pipe_vs_kylie <- tcga_vs_gtex_gene_counts[tcga_vs_gtex_gene_counts$gene %in% kylie_gene_counts$gene, ]
common_gepia_vs_kylie <- tcga_gene_counts[tcga_gene_counts$gene %in% kylie_gene_counts$gene, ]
