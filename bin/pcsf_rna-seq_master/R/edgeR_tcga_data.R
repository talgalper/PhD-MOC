...
for (i in seq_along(stages)) {
  ...
  bcv <- plotBCV(tagwise)
  #ggsave(bcv, filename = paste0("edgeR_results/tcga_data/", stage, "/", stage, "_BCV_plot.png"), device = "png")
  ...
  #ggsave(filename = paste0("edgeR_results/tcga_data/", stage, "/",  stage, "_smear_plot.png"), device = "png")
  ...
  pvalue <- ggplot(hits, aes(x=logFC, y=PValue)) + geom_point()
  #ggsave(pvalue, filename = paste0("edgeR_results/tcga_data/", stage, "/", stage, "_Pvalue_plot.png"), device = "png")
  
  write.csv(hits, paste0("edgeR_results/tcga_data/", stage, "/", stage, "_edgeR_hits.csv"))
}
