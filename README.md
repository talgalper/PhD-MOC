...
2. **Network propagation:** feed the ranked gene lists into [`Hierarchical_HotNet/`](Hierarchical_HotNet/) using `HHnet_run.sh` to derive significant subnet hierarchies saved under `MOC/results/`. Follow the script to enrich the 
