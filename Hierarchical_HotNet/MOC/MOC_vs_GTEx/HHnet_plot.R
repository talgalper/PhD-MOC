...
hh_results <- read_lines("MOC/MOC_vs_GTEx/results/clusters_STRING_MOC_logFC.tsv", skip = 7)
...
write_graph(subnet_neighs, "MOC/MOC_vs_GTEx/results/hhnet_netNeighs.graphml", format = "graphml")
write_graph(subnet, "MOC/MOC_vs_GTEx/results/hhnet_subnet.graphml", format = "graphml")

subnet_neighs <- read_graph("MOC/MOC_vs_GTEx/results/hhnet_netNeighs.graphml", format = "graphml")
subnet <- read_graph("MOC/MOC_vs_GTEx/results/hhnet_subnet.graphml", format = "graphml")
...
fwrite(df_subnet, "MOC/MOC_vs_GTEx/results/df_subnet.csv")
fwrite(df_subnetNeighs, "MOC/MOC_vs_GTEx/results/df_subnetNeighs.csv")
...
save(cluster_GO, file = "~/OneDrive - RMIT University/PhD/large_git_files/MOC/MOCvs_GTEx_HHnet_cluster_GO.RData")
load("~/OneDrive - RMIT University/PhD/large_git_files/HHnet/MOCvs_GTEx_HHnet_cluster_GO.RData")
fwrite(GO_formatted, "MOC/MOC_vs_GTEx/results/HHnet_cluster_GO.csv")
