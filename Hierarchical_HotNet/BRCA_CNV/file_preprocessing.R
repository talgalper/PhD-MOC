...
cnv_summary_filt <- subset(cnv_summary_filt, select = c("gene", "alterations_percentage"))
...
fwrite(cnv_summary_filt, "BRCA_CNV/data/cnv_alterations.csv", col.names = F, sep = "\t")
